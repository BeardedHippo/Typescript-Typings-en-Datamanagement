...
export const allNewTracks = [
    new TracksAudioOnly('stringA', [0, 2, 3], [0, 1, 3], false, false, true, false, false, false, false, ['MP3', 'WAV']),
    ...
    new TracksAudioOnly('string', [1, 3], [3, 1], false, false, true, false, false, false, false, ['MP3', 'WAV']),
    new TracksAudioOnly('string', [3], [0], false, false, true, false, false, false, false, ['MP3', 'WAV']),
];
